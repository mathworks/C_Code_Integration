...
cfg.PostCodeGenCommand = 'post_codegen';
...
%% Invoke MATLAB Coder
codegen('-config', 'cfg', 'ParkingMeterLowLevel', '-nargout', '0', '-d', '.\C_project\codegen'); 

%% Start the standalone executable
system('.\C_project\Parking_Meter_Project\x64\Debug\Parking_Meter_Project.exe&');
% system('.\C_project\Parking_Meter_Project\x64\Release\Parking_Meter_Project.exe&');
