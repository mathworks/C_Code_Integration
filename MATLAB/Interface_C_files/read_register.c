...
TCHAR SHARED_MEMORY_NAME_READ[] = TEXT("ParkingMeter.SharedMemory");
...
/*******************************************************************************
* Function open_shared_memory_read()
