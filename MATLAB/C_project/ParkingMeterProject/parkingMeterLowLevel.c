...
static void standard_operation_mode(void)
{
  ...
  unsigned char g_a;
  unsigned char h_register_value;
  ...
  do {
    ...
    do {
      ...
      /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
      b_a = read_register(40963);
      e_register_value = (unsigned char)(b_a & 159);

      /*  Set the corresponding bit of the register depending on can_give_coins_back */
      if (((register_value & 1) != 0) && ((b_register_value & 2) != 0) &&
          ((c_register_value & 4) != 0) && ((d_register_value & 8) != 0)) {
        /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
        /*  Function write_interface() */
        /*  Goal  : Define the interface layer writing data to external HW registers */
        /*  IN    : - register_address: address of the register in unsigned 16 bit */
        ...
        /*  OUT   : - */
        /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
        write_register(40963, (unsigned char)(e_register_value | 32));
      } else {
        /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
        /*  Function write_interface() */
        /*  Goal  : Define the interface layer writing data to external HW registers */
        ...
        /*  OUT   : - */
        /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
        write_register(40963, (unsigned char)(e_register_value | 64));
      }
    ...
    if (master_switch_off) {
      ...
      /*  OUT   : - */
      /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
      write_register(40963, (unsigned char)(e_a | 128));
      ...
      do {
        ...
        if (inserted_amount < 120) {
          ...
          if ((g_a & 2) != 0) {
            ...
            return_coins(inserted_amount);
            exitg1 = 1;
          } else {
            /*  Update the amount of money to pay if a coin has been inserted */
            h_register_value = f_register_value;
            ...
            if (new_reg_value != f_register_value) {
              /*  Update the amount of coins already inserted */
              if (((new_reg_value & 1) != 0) && ((f_register_value & 1) == 0)) {
                temp_amount = 10U;
              } else if (((new_reg_value & 2) != 0) && ((f_register_value & 2) ==
                          0)) {
                temp_amount = 20U;
              } else if (((new_reg_value & 4) != 0) && ((f_register_value & 4) ==
                          0)) {
                temp_amount = 50U;
              } else if (((new_reg_value & 8) != 0) && ((f_register_value & 8) ==
                          0)) {
                temp_amount = 100U;
              } else {
                if (((new_reg_value & 16) != 0) && ((f_register_value & 16) == 0))
                {
                  temp_amount = 200U;
                }
              }
              ...
              h_register_value = new_reg_value;
            }

            f_register_value = h_register_value;
          ...
          /*  Set the selected bit to '1' and write the new value to the register */
          g_register_value = (unsigned char)(f_a | 16);
          ...
          /*  OUT   : - */
          /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
          write_register(40963, g_register_value);
          ...
          /*  OUT   : - */
          /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
          write_register(40963, (unsigned char)(g_register_value ^ 16));
          ...
          return_coins((unsigned short)(inserted_amount - 120));
          exitg1 = 1;
        }
      } while (exitg1 == 0);
    }
      ...
      switch (choice) {
       ...
       case 2:
        ...
        do {
          ...
          /*  Force the string format definition in the generated C code for scanf_s */
          b_nb_input_types = scanf_s("%d%c", &data, &b_terminator, 1);
       ...
       case 3:
        ...
        do {
          ...
          /*  Force the string format definition in the generated C code for scanf_s */
          c_nb_input_types = scanf_s("%d%c", &state, &c_terminator, 1);
       ...
       case 6:
        ...
        do {
          ...
          /*  Force the string format definition in the generated C code for scanf_s */
          d_nb_input_types = scanf_s("%d%c", &b_data, &d_terminator, 1);
       ...
       case 7:
        ...
        do {
          ...
          /*  Force the string format definition in the generated C code for scanf_s */
          e_nb_input_types = scanf_s("%d%c", &b, &e_terminator, 1);
