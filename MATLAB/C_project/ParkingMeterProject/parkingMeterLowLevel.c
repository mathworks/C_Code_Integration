...
static void TestMode_display_value(void)
{
  ...
  do {
    ...
    terminator = ' ';
    printf("%s", "Enter the hundreds of cents value to print on the 7 segments "
                 "displays: ");
    fflush(stdout);
  ...
  printf("%s\n\n", "The desired value has been successfully written on the 7 "
                   "segments displays.");
  fflush(stdout);
  printf("%s\n", "-------------------------------------------------------------"
                 "------------------");
  ...
  do {
    ...
    if (coin_choice != 0) {
      ...
      do {
        ...
        /*  Get input data using the Windows C API */
        terminator = ' ';
        printf("%s", "Enter the menu entry corresponding to the coins value to "
                     "give back [0-4]: ");
        fflush(stdout);
...
static void display_cents_value(unsigned short cents_value)
{
  ...
  if (cents_value == 45) {
    ...
    /*  Compute the cent */
    digit_value = (unsigned short)((unsigned int)cents_value -
                                   (int)(cents_value / 10U) * 10);
    display_digit(1U, digit_value, 0.0);
    /*  Compute the tens of cents */
    b_remainder = (unsigned short)rt_roundd(
        (double)(unsigned short)((unsigned int)cents_value - digit_value) /
        10.0);
    digit_value = (unsigned short)((unsigned int)b_remainder -
                                   (int)(b_remainder / 10U) * 10);
    display_digit(2U, digit_value, 0.0);
    /*  Compute the hundreds of cents */
    x = (unsigned short)rt_roundd(
        (double)(unsigned short)((unsigned int)b_remainder - digit_value) /
        10.0);
                                        ...
                                        unsigned short coin_value)
{
  ...
  while ((!exitg1) && (remaining_amount >= coin_value)) {
    ...
    if (available) {
      ...
      remaining_amount =
          (unsigned short)((unsigned int)remaining_amount - coin_value);
    } else {
      exitg1 = true;
    }
  }
...
static void standard_operation_mode(void)
{
  ...
  do {
    ...
    do {
      ...
      /*  Goal  : check if a specific coin's value is still available in the
       * cash box */
      /*  IN    : - const_obj: constants object used in the entire application
       */
      /*  IN/OUT: - */
      /*  OUT   : - boolean stating if this coin's value is still available or
       * not */
      /*            '0' => coin's value not available anymore */
      /*            '1' => coin's value still available */
      /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
       */
      /*  Get the current register's status of the available coins in the cash
       * box */
      /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
       */
      /*  Function read_interface() */
       ...
       */
      /*  IN/OUT: - */
      /*  OUT   : - register_value: value stored in the register as an unsigned
       * 8 bit */
      /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
       */
      ...
      if (((b_a & 1) != 0) && ((c_a & 2) != 0) && ((d_a & 4) != 0) &&
         ...
         * bit */
        /*          - new_value: value to store in the register as an unsigned 8
         * bit */
        /*  IN/OUT: - */
        /*  OUT   : - */
        /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
       ...
       */
      /*  Function sleep_interface() */
      /*  Goal  : Define the interface layer to pause the system for an amount
       * of time */
      /*  IN    : - duration: time duration in seconds */
      /*  IN/OUT: - */
      /*  OUT   : - */
      ...
      if ((g_a & 4) == 0) {
        ...
        /*  Goal  : Poll the button register continuously to see if the green
         * button has */
        /*          been pressed */
        /*  IN    : - const_obj: constants object used in the entire application
         */
    ...
    if (master_switch_off) {
      ...
      do {
        ...
        if (inserted_amount < 120) {
            ...
            if (new_reg_value != b_register_value) {
              ...
              if (((new_reg_value & 1) != 0) && ((b_register_value & 1) == 0)) {
                temp_amount = 10U;
                         ...
                         ((b_register_value & 2) == 0)) {
                temp_amount = 20U;
              } else if (((new_reg_value & 4) != 0) &&
                         ((b_register_value & 4) == 0)) {
                temp_amount = 50U;
              } else if (((new_reg_value & 8) != 0) &&
                         ((b_register_value & 8) == 0)) {
                temp_amount = 100U;
              } else if (((new_reg_value & 16) != 0) &&
                         ((b_register_value & 16) == 0)) {
                temp_amount = 200U;
              }
          ...
          /*  Return as much as possible higher coin's values at first */
          b_remaining_amount =
              return_coin_value((unsigned short)(inserted_amount - 120), 100U);
      ...
      if (choice != 0) {
        ...
        case 1:
          ...
          do {
            ...
            printf("%s", "Enter the address of the register to access in "
                         "hexadecimal within the following range "
                         "[0xA000-0xA003] or [0xA010-0xA012]: ");
            fflush(stdout);
            /*  Force the string format definition in the generated C code for
             * scanf_s */
            scanf_s("%x", &register_text);
            /*  Check if the provided address is pointing to an existing
             * register  */
            i = 0;
            exitg3 = false;
            while ((!exitg3) && (i < 7)) {
             ...
             */
            if (!is_right_value) {
              printf("The address provided is not within the right range of "
                     "addresses!\n");
              fflush(stdout);
          ...
          do {
            ...
            /*  Check if the provided data is an integer number */
            guard1 = false;
            if (e_nb_input_types == 2) {
              f_bool = !(e_terminator != '\x0a');
              if (f_bool) {
                /*  Check if the value is within the allowed range */
                if ((b_data >= 0) && (b_data <= 999)) {
                  exitg2 = 1;
                } else {
                  printf("The value provided must be between %d and %d!\n", 0,
                         999);
          ...
          /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
           */
          write_register((unsigned short)register_text, b_data);
          printf("%s\n\n", "The desired value has been successfully written in "
        ...
        case 6:
          ...
          do {
            ...
            /*  Get input data using the Windows C API */
            c_terminator = ' ';
            printf("%s", "Set the position of the coin\'s flap [open => \'1\', "
                         "close => \'0\']: ");
            fflush(stdout);
            /*  Force the string format definition in the generated C code for
             * scanf_s */
        ...
        case 7:
          ...
          do {
            ...
            /*  Get input data using the Windows C API */
            d_terminator = ' ';
            printf("%s", "Enter the desired time to read the inputregisters in "
                         "seconds [\'1\'-\'100\']: ");
            fflush(stdout);
            /*  Force the string format definition in the generated C code for
             * scanf_s */
          ...
          for (c_i = 0; c_i <= b_i; c_i++) {
            ...
            printf("Elapsed time   : %3.1f\n",
                   (float)rt_roundd(((double)c_i + 1.0) * 100.0 / 1000.0));
            fflush(stdout);
            /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
             */
            /*  Function sleep_interface() */
