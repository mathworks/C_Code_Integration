...
DESTINATION_PATH = '..\Parking_Meter_Project';
BUILD_COMMAND = 'MSBuild ..\Parking_Meter_Project.sln /p:Configuration=';
% Go to the codegen folder
cd('C_project\codegen');
...
% Go to the VS2017 project's folder
cd(DESTINATION_PATH);
% Build the VS2017 project
...
if (error_flag == 0)
  ...
  fprintf('C:\Program Files (x86)\Microsoft Visual Studio\2017\Professional\MSBuild\15.0\Bin\n');
